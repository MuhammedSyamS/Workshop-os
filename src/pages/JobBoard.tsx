...
export default function JobBoard() {
  ...
  if (loading) return <div className="p-4 text-slate-500 font-bold text-sm">Loading Job Orders...</div>;

  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-heading font-bold text-slate-900">Job Board</h1>
          ...
          return (
            <div key={status} className="snap-start min-w-[320px] w-[320px] shrink-0 bg-white border border-slate-200 flex flex-col max-h-full">
              <div className="px-4 py-3 border-b border-slate-200 bg-slate-50/50 flex justify-between items-center">
                <span className="font-heading font-medium text-sm text-slate-900">{status.replace('_', ' ')}</span>
              ...
              <div className="p-3 overflow-y-auto flex-1 space-y-3">
                    ...
                    <CardContent className="p-3">
                      ...
                      <div className="pt-2 border-t border-slate-200 flex justify-between items-center" onClick={e => e.stopPropagation()}>
                        ...
                        <select 
                          ...
                          className="bg-white border border-slate-200 text-slate-900 text-[10px] font-bold py-1 px-2 focus:outline-none focus:border-blue-600"
                        >
                ...
                {columnJobs.length === 0 && (
                  <div className="text-center py-8 text-[10px] text-slate-400 font-bold border border-dashed border-slate-200">
                    NO JOBS IN QUEUE
                  </div>
                )}
              </div>
          ...
          <Card className="w-full max-w-2xl bg-slate-50 border-slate-200">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 gap-8 mb-6">
                <div>
                  <h3 className="text-blue-600 font-medium text-sm mb-3 border-b border-slate-200 pb-2">Customer Details</h3>
                ...
                <div>
                  <h3 className="text-blue-600 font-medium text-sm mb-3 border-b border-slate-200 pb-2">Vehicle Details</h3>
                  <div className="text-sm text-slate-900 space-y-2">
              ...
              <div className="mb-6">
                <h3 className="text-blue-600 font-medium text-sm mb-3 border-b border-slate-200 pb-2">Complaint / Issue</h3>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-slate-200 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <select 
                    ...
                    className="bg-white border border-slate-200 text-blue-600 text-sm font-bold py-1.5 px-3 focus:outline-none focus:border-blue-600"
                  >
                    {STATUSES.map(s => <option key={s} value={s}>{s.replace('_', ' ')}</option>)}
                  </select>
                </div>
